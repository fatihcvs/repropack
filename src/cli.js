...
if (args.length === 1 && args[0] === '--help') {
  console.log('repropack create <recipe.json> | verify <package-directory>\nRecipe: root, output, files[], command[], signature; optional exitCode, cwd, timeoutMs.\nCreates or verifies a local package; does not execute or upload it.');
...
} else { console.error('Usage: repropack create <recipe.json> | verify <package-directory> | --help'); process.exitCode = 2; }
