...
ReproPack's skill at a recorded commit. The current planned comparator is
GitHub's `awesome-copilot/skills/bug-reproduction-brief`; inspect its current
license, complete resources and instructions before importing it. No comparator
has been executed or vendored yet.
